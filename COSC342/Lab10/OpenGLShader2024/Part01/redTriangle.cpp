...
int main( void )
{
    ...
    Triangle* secondTriagnle = new Triangle();
    ...
    Shader* yellowShader = new ColorShader(glm::vec4(1.0,1.0,0.0,0.0), "colorShader");
    Shader* redShader = new ColorShader(glm::vec4(1.0,0.0,0.0,0.0), "colorShader");

   // myTriangle->setShader(yellowShader);
    secondTriagnle->setShader(redShader);
    myQuad->setShader(yellowShader);
    
    secondTriagnle->setTranslate(glm::vec3(1.0,1.0,0));
    
    Scene* myScene = new Scene();
  //  myScene->addObject(myTriangle);
    myScene->addObject(secondTriagnle);
