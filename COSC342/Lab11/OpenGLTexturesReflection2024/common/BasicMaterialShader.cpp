...
void BasicMaterialShader::setLightColour(glm::vec3 diffuseLightColor){
    m_diffuseLightColor = diffuseLightColor;
    m_diffuseLightColorID = glGetUniformLocation(programID, "diffuseLightColor");
    glUniform3f(m_diffuseLightColorID, m_diffuseLightColor.x, m_diffuseLightColor.y, m_diffuseLightColor.z);
